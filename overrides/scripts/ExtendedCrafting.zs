...
makeExtremeRecipe7(<gregtech:meta_tool:7>.withTag({"GT.ToolStats": {Material: "darmstadtium"}}),
    ["FFFF   ",
     "FBSF   ",
     "FDDF   ",
     "PLLLRRR",
     ...
     "FBSF   ",
     "FFFF   "],
    { F : <ore:blockPolytetrafluoroethylene>,
      P : <ore:platePolytetrafluoroethylene>,
      B : <ore:blockStyreneButadieneRubber>,
      S : <ore:blockSiliconRubber>,
      R : <ore:stickLongBismuthBronze>,
...
makeExtremeRecipe7(<gregtech:meta_tool:37>.withTag({"GT.ToolStats": {Material: "darmstadtium"}}),
    ["   TT  ",
     ...
     " L     ",
     "L      "],
    { T : <ore:blockPolytetrafluoroethylene>,
      B : <ore:blockStyreneButadieneRubber>,
      R : <ore:rotorDarmstadtium>,
      P : <ore:plateDarmstadtium>,
      L : <ore:stickLongVanadiumSteel> });
